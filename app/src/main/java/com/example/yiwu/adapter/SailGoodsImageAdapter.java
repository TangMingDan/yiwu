 ...
 * Created by 朱旭辉
 * Time  2019/11/20
 * Describe:上架物品adapter
 */
public class SailGoodsImageAdapter extends BaseAdapter {
    private ArrayList<ImageItem> imageItems;
    private final int SUCCESSFUL = 200;
    public SailGoodsImageAdapter(ArrayList<ImageItem> imageItems) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        SailGoodsImageAdapter.ViewHolder holder = null;
        if (convertView == null) {
            holder = new SailGoodsImageAdapter.ViewHolder();
            ...
            holder = (SailGoodsImageAdapter.ViewHolder) convertView.getTag();
        }
